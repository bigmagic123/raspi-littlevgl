 ...
 *  PL011 RASPI2
 */
#define UART0_DR(BASE)        (HWREG32(BASE+0x00))
#define UART0_FR(BASE)        (HWREG32(BASE+0x18))
#define UART0_IBRD(BASE)      (HWREG32(BASE+0x24))
#define UART0_FBRD(BASE)      (HWREG32(BASE+0x28))
#define UART0_LCRH(BASE)      (HWREG32(BASE+0x2C))
#define UART0_CR(BASE)        (HWREG32(BASE+0x30))
#define UART0_IMSC(BASE)      (HWREG32(BASE+0x38))
#define UART0_ICR(BASE)       (HWREG32(BASE+0x44))
